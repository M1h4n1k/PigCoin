...
def get_users_within_coins_range(
    db: Session,
    min_total_coins: int,
...
def get_position_in_league(
    db: Session, user: models.User, coins_max: int | None
) -> int:
...
def make_transaction(
    db: Session, from_user: models.User, to_user: models.User, amount: int
) -> models.Transaction:
...
def get_transactions(
    db: Session, user: models.User, offset: int, limit: int
) -> list[type[models.Transaction]]:
    return (
