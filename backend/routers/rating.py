...
async def get_user_rating(
    ...
    users = crud.users.get_users_within_coins_range(
        db, *get_user_league_range(league), offset, limit
    )
    return users
...
async def get_club_rating(
    ...
    clubs = crud.clubs.get_clubs_within_coins_range(
        db, *get_club_league_range(league), offset, limit
    )
    return clubs
